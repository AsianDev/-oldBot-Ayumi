...
module.exports = new Event("guildMemberAdd", async (client, member, message) => { 
    ...
    if (member.user.bot) return;
     channel.send(`<a:HashiHeart:922084304518004779> <@${member.user.id}> Welcome to Ikigai! Go get some roles in <#949997053004640306> and join some clubs in <#911767279526613072> ! <a:Kawaii_Bunny:922261803583553556>`)
