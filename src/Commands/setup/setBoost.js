...
async run(message, args, client) {
    ...
    .setTitle("Successfully set the Boost Channel. <a:exclamation_mark_red:915208461514604604>")
    .setDescription(`**${message.author.username}** You have set the booster channel!`)
    .addField("Boost Channel:", `<#${channel.id}>`)
    .setURL("https://media1.tenor.com/images/8d189128d67c185a55462f5a77f9e825/tenor.gif")

    const UpdatedEmbed = new Discord.MessageEmbed()
    .setColor(colour.lightish_blue)
    .setTitle("Successfully updated the Boost Channel. <a:exclamation_mark_red:915208461514604604>")
    .setDescription(`**${message.author.username}** You have updated the Boost channel!`)
    .addField("Boost Channel:", `<#${channel.id}>`)
    .setURL("https://media1.tenor.com/images/8d189128d67c185a55462f5a77f9e825/tenor.gif")
    ...
    .setColor("RED")
    .setDescription("Please mention the channel to set the Boost channel as!")
    ...
    if (!data) {
        ...
        await data.updateOne({ BoostChannel: channel.id })
