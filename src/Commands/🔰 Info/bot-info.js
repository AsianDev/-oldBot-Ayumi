...
module.exports = new Command({
   ...
   botPermissions: "SEND_MESSAGES",
    ...
    async run(message, args, client) {
        ...
        .setColor(c.pink)
        .setDescription(`*Heyaa~* I currently have **${client.commands.cache.size}** __commands__!`)
        .addField(":robot: Created at", `${utc(client.user.createdTimestamp).format("Do MMMM YYYY HH:mm:ss")}`, true)
