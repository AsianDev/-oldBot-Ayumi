...
module.exports = new Command({
  ...
  async run(message, args, client) {
    ...
    const helpembed = new Discord.MessageEmbed()
        ...
        .addField('Catergory', " 🎬 ``Action``\n  🪙 `Economy`\n 😜 ``Fun`` \n 🖼️ ``Image`` \n <:Info:940625513746165781> ``Information``\n  🛡️ ``Moderation``\n 🗒️ ``Setup``\n <:Ayu_Link:967228533917241365> ``Support``\n ✅ ``Utility``\n 🖼️ ``Wallpaper``\n\n   **|** [**Discord**](https://discord.gg/pTYkk68bS2)  **|** [**Vote**](https://top.gg/servers/873143392488525834)", false)
            ...
            .setFooter({ text:` > Ayumi • ${message.channel.name}`})
              ...
              .setFooter({ text:` > Ayumi • ${message.channel.name}`})
                ...
                .setFooter({ text:` > Ayumi • ${message.channel.name}`})
                  ...
                  .addField('__<:Ayu_UwU:967229168288948224> EMOJI__', '\`\`\`ini\n[ emojiInfo, emojiList, enlarge-emoji, remove-emoji, rename-emoji ] ]\n\`\`\`')
