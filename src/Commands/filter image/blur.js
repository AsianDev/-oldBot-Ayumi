...
module.exports = new Command({
    ...
    async run(message, args, client) {
         ...
         try {
           ...
           const buffer = await AmeAPI.generate("blur", { url: user.displayAvatarURL({ format: "png", size: 512 }) });
           const attachment = new Discord.MessageAttachment(buffer, "blur.png");

           m.edit({ content: "Generated <:Iki_mochaHeart:939483315952578610>", files: [attachment], name: "blur.png", allowedMentions: {repliedUser: false}});
         } catch (err) {
