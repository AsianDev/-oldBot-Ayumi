  ...
  type: "Text",
    ...
    async run(message, args, client) {
         ...
         try {
          ...
          const buffer = await AmeAPI.generate("sharpen", { url: user.displayAvatarURL({ format: "png", size: 512 }) });
           const attachment = new Discord.MessageAttachment(buffer, "sharpen.png");

               m.edit({ content: "Generated <:Kao_mochaDance:765175325273227274>", files: [attachment], name: "sharpen.png", allowedMentions: {repliedUser: false}});
         } catch (err) {
