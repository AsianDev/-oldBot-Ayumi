     ...
     async run(message, args, client) {
        ...
        if (!fetchBans) {
            ...
            .setDescription('This server does not have any banned members.')
                ...
                return message.channel.send({ embeds: [NoBannedUsersEmbed]});
        } else {
            ...
            const BannedMemberListEmbed = new Discord.MessageEmbed()
            ...
            message.channel.send({ embeds: [BannedMemberListEmbed]})
        }}})